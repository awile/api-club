...
1. First, we will use a base image that has python 3.12.2 installed and configured
2. We copy our application code into the container
3. We copy our dependency file into the container (notice we don't need our development dependencies for running this)
4. We install all our application dependencies
